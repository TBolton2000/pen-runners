...
class MainPage extends Component{
    constructor(props) {
        ...
        // this.userRef = this.db.collection('users').doc(props.currentUser.uid);
        // this.userRef.set(this.state.drawings);
    }
        ...
        return (
            <div className="side-by-side">
                ...
                <Map ref={e => { this.mapInstance = e }} viewport={this.state.viewport} onClick={(event)=>this.mapClickHandler(event,this)}>
                    ...
                    { this.state.drawIndex === null && this.state.drawings.length > 0 && this.state.drawings.map((value,idx)=>
